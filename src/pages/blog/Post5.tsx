...
const Post5 = () => (
  <BlogPost
    ...
    metaTitle="How to Make Your Website a Lead Generation Machine | SeoFX Sri Lanka"
    metaDesc="Is your website generating leads? Learn the 6 key steps to turn your Sri Lankan business website into a powerful lead generation machine. Expert tips from SeoFX."
    keywords="website lead generation sri lanka, convert website visitors sri lanka, seo lead generation, best seo company sri lanka"
  ...
  >
    ...
    <p>Never leave a website visitor at a dead end. Every page should have a clear Call-to-Action (CTA) — whether that is calling you, filling in a contact form, requesting a quote, or reading another page. Strategically placed CTAs are one of the most powerful lead generation tools on any website.</p>
    <h3>3. Map the Customer Journey</h3>
    <p>Walk through your website as a first-time visitor. What do they see first? Where do they go next? Is the path to enquiry clear and intuitive? Your website should have a logical, welcoming flow that guides visitors from awareness to interest to action — naturally and without friction.</p>
    <h3>4. Publish Helpful, Informative Content</h3>
    <p>Many of your future customers do not yet know they have the problem your business solves. Educational blog posts, guides, and informative service pages not only rank on Google — they build trust with visitors and position your business as the obvious expert solution.</p>
    <h3>5. Build Credibility and Trust</h3>
