      ...
      <div className="container-tight py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-white/70">
              ...
              <li><Link to="/google-ads-sri-lanka" className="hover:text-accent">Google Ads Sri Lanka</Link></li>
        ...
        <div className="mt-12 border-t border-white/10 pt-6">
          ...
          <div className="mt-4 flex flex-col gap-3 text-xs text-white/50 md:flex-row md:items-center md:justify-between">
            <p>© 2022 SeoFX. All Rights Reserved. Best SEO Company in Sri Lanka.</p>
